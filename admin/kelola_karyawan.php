                    ...
                    <tbody class="text-sm text-gray-700">
                        ...
                        <tr class="hover:bg-blue-50/30 transition-colors group border-b border-gray-50">
                            ...
                            <td class="p-4 text-center">
                                ...
                                <?php else: ?>
                                <span
                                    class="inline-flex px-3 py-1 items-center gap-1.5 rounded-full bg-green-50 text-green-700 font-bold border border-green-200 text-xs">
                                    <svg class="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd"
                                            d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clip-rule="evenodd">
                                        </path>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <select name="role"
                                ...
                                <option value="owner">Owner (Hanya melihat Laporan)</option>
                            </select>
                        </div>
                    </div>
