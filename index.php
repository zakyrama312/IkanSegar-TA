...
<body class="bg-slate-50 text-slate-800 flex flex-col min-h-screen selection:bg-blue-200 selection:text-blue-900">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-20">
                ...
                <a href="index.php" class="flex-shrink-0 flex items-center">
                    <span class="text-3xl font-extrabold text-blue-600 tracking-tighter">Segar<span
                            class="text-sky-400">Laut</span>.</span>
                </a>
    ...
    <footer class="bg-slate-900 text-slate-400 py-12 border-t border-slate-800 mt-auto">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 class="text-2xl font-bold text-white mb-4 tracking-tighter">Segar<span class="text-sky-400">Laut</span>.
            </h2>
            <p class="mb-6 max-w-md mx-auto">Platform penjualan ikan segar terpercaya. Dapatkan ikan berkualitas tinggi
                langsung dari nelayan dengan harga terbaik.</p>
            ...
            <p class="text-sm">&copy; <?php echo date('Y'); ?> SegarLaut. E-Commerce by PHP Native.</p>
        </div>
    </footer>
